...
#
# Generated by export_simulation on Tue Feb 28 10:35:20 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './fifo_ddr3_read.sh' script.

./fifo_ddr3_read.sh -reset_run
...
./fifo_ddr3_read.sh -noclean_files

For more information on the script, please type './fifo_ddr3_read.sh -help'.
